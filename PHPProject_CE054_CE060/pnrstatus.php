...
<head>
    ...
    html {
        background: url(img/r3.jpg) no-repeat center center fixed;
...
include("header.php"); ?>
    <center>
        <div id="pnr">Check your PNR status here:<br /><br />
            <form method="post" name="pnrstatus" action="pnrstatus.php" class="container-fluid">
                <div id="pnrtext"><input type="text" name="pnr" size="30" maxlength="10" placeholder="Enter PNR here">
                </div>
                <br /><br />
