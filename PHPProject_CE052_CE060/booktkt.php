    ...
    <div id="booktkt" class="container-fluid d-flex justify-content-center">
        ...
        <form method="post" name="journeyform" onsubmit="return validate()">
            <select id="trains" name="trains" required>
                ...
                <option value="duronto">Maharaja Express</option>
                <option value="geetanjali">Geetanjali Express</option>
                <option value="garibrath">Garib Rath</option>
                <option value="mysoreexp">Himsagar Express</option>
            ...
            <div style="padding-left:130px;">
                ...
                <select name="source">
                    <option value="pune">Dharmshala</option>
                    <option value="delhi">Delhi</option>
                    <option value="mumbai">Mumbai</option>
                    <option value="Chennai">Chennai</option>
                    <option value="New Delhi">New Delhi</option>
                    <option value="anand vihar">Jammu </option>
                    <option value="Surat">Surat</option>
                    <option value="Kota">Darjeeling</option>
                ...
                <select name="destination">
                    <option value="Mumbai">Mumbai</option>
                    <option value="New Delhi">New Delhi</option>
                    <option value="Surat">Dharmshala</option>
                    <option value="Banglore">Banglore</option>
                    <option value="delhi">Delhi</option>
                    <option value="kota">Darjeeling</option>
